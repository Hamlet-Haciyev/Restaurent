        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone_3 = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Location = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    Location_Note = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Addresss = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Phone = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    Email = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    About = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Addresss_2 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Phone_2 = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeaturesToRestaurants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FeaturesToRestaurants_Features_FeaturesId",
                        column: x => x.FeaturesId,
                        principalTable: "Features",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FeaturesToRestaurants_Restaurants_RestaurantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FullName = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    Reserve_Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Person_Count = table.Column<byte>(type: "tinyint", nullable: false),
                    Series_Number = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    RestaurantId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RestBooks_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeaturesToRestaurants_FeaturesId",
                table: "FeaturesToRestaurants",
                column: "FeaturesId");

            migrationBuilder.CreateIndex(
                name: "IX_FeaturesToRestaurants_RestaurantId",
                table: "FeaturesToRestaurants",
                column: "RestaurantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestBooks_RestaurantId",
                table: "RestBooks",
                column: "RestaurantId");
