#pragma checksum "C:\Users\FX505GT\Desktop\Asp.Net Project\DirectList (Backend-Project)\DirectList (Backend-Project)\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8a8720c3f2f43caa4ae2a4a94de4404d5de691e3"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8a8720c3f2f43caa4ae2a4a94de4404d5de691e3", @"/Views/Home/Index.cshtml")]
    ...
    <div class=""fullwidth-carousel-container"">
        <div class=""fullwidth-slick-carousel category-carousel"">
            ...
            <div class=""fw-carousel-item"">
                ...
                ");
            WriteLiteral(@"        <div class=""category-box-background"" style=""background-image: url('assets/images/cat-img-5.jpg')"">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class=""category-box-container text-center"">
                    <div class=""category-box"">
                        <div class=""category-box-content"">
                            ...
                            <h3><a href=""JavaScript:Void(0);"" clas");
            WriteLiteral(@"s=""text-white"">Eat & Drink</a></h3>
        ...
        ");
            WriteLiteral(@"                                    </div>
                    ...
                    <div class=""carousel-item"">
                        <div class=""category-box-container text-center"">
                 ");
            WriteLiteral(@"           <div class=""listing-item-container"">
                                <div class=""listing-item text-center"">
                                    <div class=""mostviewed-bg"" style=""background-image: url('assets/images/most-img-2.jpg')"">
                                        <div class=""listing-item-content"">
                                            ...
                                            <span class=""badge badge-pill badge-primary text-uppercase o");
            WriteLiteral(@"pen-close-banner"">Open</span>
                                        </div>
                                        <span class=""round-pill like-banner d-block bg-primary""><i class=""fa fa-heart-o""></i></span>
                                    </div>
                                </div>
                            ...
                            <div class=""listing-item-container"">
                                <div class=""listing-item text-center"">
                                    <div class=""mostviewed-bg"" style=""background-image: url('assets/images/most-img-1.jpg')"">
                                        <div class=""listing-item-content"">
                                            <div class=""list-logo"">
                                                <a> <img src=""assets/images/logo-4.png"" width=""80""");
            WriteLiteral(@" height=""80"" alt=""list-logo""></a>
                                            </div>
                                            <span class=""badge badge-pill badge-primary text-uppercase category-banner"">Eat & Drink</span>
...
<div class=""bloc");
            WriteLiteral(@"k-space bg-primary"">
    <div class=""container"">
        <div class=""block-head text-center mb-5"">
    ...
    <div class=""container"">
        <div class=""row row-grid mt-5"">
            <div class=""col-lg-4 text-center"">
                ...
                <p class=""text-white mt-3"">Proin dapibus nisl ornare diam varius tempus. Aenean a quam luctus, finibus ");
            WriteLiteral(@"tellus ut, convallis eros sollicitudin turpis.</p>
            </div>
            <div class=""col-lg-4 text-center"">
                <div class=""icon icon-lg icon-shape bg-gradient-white shadow rounded-circle text-primary"">
            ...
            <div class=""col-lg-4 text-center"">
                ...
                <p class=""text-white mt-3"">Faucibus ante, in porttitor tellus blandit et. Phasellus tincidunt metus lectus sollicitudin feugiat pharetr");
            WriteLiteral(@"a consectetur.</p>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class=""col-lg-4"">
                        <div class=""card card-lift--hover shadow border-0"">
                            ...
                            <div class=""card-body py-4"">
                                ...
                                <p>22 August 2018</p>
                                <p class=""description mb-4"">Sed sed tristique nibh iam porta volutpat finibus. Donec in aliquet");
            WriteLiteral(@" urneget mattis lorem. Pellentesque pellentesque</p>
